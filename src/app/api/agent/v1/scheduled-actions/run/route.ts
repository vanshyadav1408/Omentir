...
import { runScheduledActionNowResource } from "@/lib/server/agent-api-actions";
...
export async function POST(request: NextRequest) {
  ...
  try {
    return NextResponse.json(await runScheduledActionNowResource(auth.context, body.body));
  } catch (error) {
