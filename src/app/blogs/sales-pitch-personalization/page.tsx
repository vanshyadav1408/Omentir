...
export const metadata = createPageMetadata({
  ...
  description: "How to write personalized B2B sales pitches that get replies, using modular messaging templates, signal-led hooks, and safe LinkedIn delivery.",
...
const tocItems: { id: string; label: string; level: 1 | 2 }[] = [
  ...
  { id: "mitigating-objections", label: "Handling common B2B objections in your first touch", level: 1 },
...
export default function BlogPost() {
  return (
    ...
    >
      ...
      <p>
        Many sales teams have responded with shallow personalization. They use automation to pull a prospect's university or city and insert it into a standard pitch: "I saw you went to [University], congrats! We help companies scale outreach..." This approach is transparent and often backfires. Buyers recognize it as automated spam and archive the thread immediately.
      </p>
      <p>
        You need deep business relevance instead. Your sales pitch should focus on the prospect's professional goals, team expansion, or public company updates. Connecting your value proposition to their active initiatives shows that you have done your research and deserve their time.
      </p>
      <p>
        Omentir is built to do this kind of customization at scale. By pulling details from your product profile and matching them with a prospect's role and company context, the system drafts relevant outreach automatically. Here is how to structure a modular sales pitch that books meetings.
      </p>
      <p>
      ...
      <p>
        A useful cold message on LinkedIn should be short, low-pressure, and relevant. Structure your pitch into three core components:
      </p>
      ...
      <p>
        This modular structure makes your copy flexible and easier to reuse.
      </p>
      <p>
      ...
      <p>
        Writing personalized messages by hand for every prospect is slow. To scale your outbound pipeline, automate the sourcing of company and role context.
      </p>
      <p>
      ...
      <p>
        This is why a human-in-the-loop review queue matters. Omentir handles this by staging all AI-drafted messages inside your workspace drafts. The system does not send messages automatically; it generates the copy, links the target profile, and highlights the variables, leaving you to click approval. For detailed templates, read our review of{" "}
      ...
      <h2 id="mitigating-objections" style={{ fontFamily: "var(--font-varta)" }} className="text-2xl font-semibold tracking-tight text-black mt-10 pt-2 border-b border-zinc-200 pb-2 scroll-mt-28">
        Handling common B2B objections in your first touch
      </h2>
      <p>
        The most common objections you will face in cold outreach are: "we already have a solution," "no budget," and "we are too busy." You can lower those hurdles by addressing them directly in your copy.
      </p>
      <p>
      ...
      <p>
        Personalization does not excuse aggressive delivery. If anything, stronger personalization should make you more selective. A small batch of relevant notes gives you cleaner feedback than a huge batch of mixed-quality messages. When replies come in, you can see which hooks worked and which segments should be paused.
      </p>
      ...
      <p>
        Outbound in 2026 is won on relevance. Replace generic templates with modular, signal-led message patterns, and you can write copy that buyers actually answer.
      </p>
      <p>
