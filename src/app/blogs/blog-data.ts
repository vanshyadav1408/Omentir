export interface BlogItem {
   ...
   * drift apart and start telling crawlers something the site cannot back up.
   */
...
/**
 * A post whose `publishedDate` has not arrived yet is *scheduled*, not
 * published: it stays reachable by direct URL so it can be reviewed, but it is
 * kept out of every surface that tells a crawler the page is part of the site —
 * the sitemap, llms.txt, the /blogs index, the CollectionPage JSON-LD and
 * related-post links — and it is served `noindex`.
 *
 * The library went live all at once, which is the pattern Google treats as
 * scaled content abuse. Releasing the backlog on a Mon/Wed/Fri cadence instead
 * lets the site grow at a rate a person could plausibly sustain, and keeps
 * every date on the site true. Never backdate a post to fake an older library:
 * the crawl log contradicts it, and a `datePublished` that disagrees with the
 * crawl date is a documented manual-action trigger.
 *
 * Compared at UTC day granularity. `now` is a parameter so callers (and tests)
 * can pin it; it defaults to the current time and is read per call rather than
 * at module load, so a long-running server does not freeze the schedule at
 * whenever it booted.
 *
 * Post pages and /blogs are server-rendered per request, so a release takes
 * effect on its own. `sitemap.xml` and `llms.txt` are cached, and each sets a
 * daily `revalidate` so it cannot lag the schedule by more than a day.
 */
...
/** Posts that are actually published, newest-first ordering left to callers. */
export function liveBlogs(now?: Date): BlogItem[] {
  return ALL_BLOGS.filter((blog) => isBlogLive(blog, now));
}
...
export const ALL_BLOGS: BlogItem[] = [
  ...
  },
  {
    ...
    publishedDate: "February 1, 2027",
    updatedDate: "February 1, 2027",
    category: "Guides",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "March 3, 2027",
    updatedDate: "March 3, 2027",
    category: "Guides",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "March 5, 2027",
    updatedDate: "March 5, 2027",
    category: "Guides",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "December 4, 2026",
    updatedDate: "December 4, 2026",
    category: "Automation",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "November 6, 2026",
    updatedDate: "November 6, 2026",
    category: "Automation",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "October 16, 2026",
    updatedDate: "October 16, 2026",
    category: "Guides",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "November 13, 2026",
    updatedDate: "November 13, 2026",
    category: "Guides",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "December 11, 2026",
    updatedDate: "December 11, 2026",
    category: "Guides",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "November 25, 2026",
    updatedDate: "November 25, 2026",
  ...
  },
  {
    ...
    publishedDate: "December 9, 2026",
    updatedDate: "December 9, 2026",
    category: "Copywriting",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "January 8, 2027",
    updatedDate: "January 8, 2027",
    category: "Guides",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "December 25, 2026",
    updatedDate: "December 25, 2026",
    category: "Guides",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "February 19, 2027",
    updatedDate: "February 19, 2027",
    category: "Guides",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "December 7, 2026",
    updatedDate: "December 7, 2026",
  ...
  },
  {
    ...
    publishedDate: "November 9, 2026",
    updatedDate: "November 9, 2026",
    category: "Comparisons",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "November 23, 2026",
    updatedDate: "November 23, 2026",
    category: "Comparisons",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "December 21, 2026",
    updatedDate: "December 21, 2026",
    category: "Comparisons",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "November 4, 2026",
    updatedDate: "November 4, 2026",
    category: "Playbooks",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "January 29, 2027",
    updatedDate: "January 29, 2027",
    category: "Copywriting",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "November 2, 2026",
    updatedDate: "November 2, 2026",
    category: "Outreach",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "February 26, 2027",
    updatedDate: "February 26, 2027",
    category: "Guides",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "March 17, 2027",
    updatedDate: "March 17, 2027",
    category: "Guides",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "January 6, 2027",
    updatedDate: "January 6, 2027",
    category: "Copywriting",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "February 5, 2027",
    updatedDate: "February 5, 2027",
    category: "Guides",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "November 20, 2026",
    updatedDate: "November 20, 2026",
    category: "Automation",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "November 27, 2026",
    updatedDate: "November 27, 2026",
    category: "Guides",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "March 8, 2027",
    updatedDate: "March 8, 2027",
    category: "Guides",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "December 2, 2026",
    updatedDate: "December 2, 2026",
    category: "Playbooks",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "December 30, 2026",
    updatedDate: "December 30, 2026",
    category: "Playbooks",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "November 18, 2026",
    updatedDate: "November 18, 2026",
    category: "Playbooks",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "October 30, 2026",
    updatedDate: "October 30, 2026",
    category: "Guides",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "November 11, 2026",
    updatedDate: "November 11, 2026",
    category: "Copywriting",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "March 19, 2027",
    updatedDate: "March 19, 2027",
    category: "Guides",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "February 24, 2027",
    updatedDate: "February 24, 2027",
    category: "Guides",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "December 14, 2026",
  ...
  },
  {
    ...
    publishedDate: "December 23, 2026",
    updatedDate: "December 23, 2026",
    category: "Copywriting",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "January 18, 2027",
    updatedDate: "January 18, 2027",
    category: "Copywriting",
    readTime: "10 min read",
  ...
  },
  {
    ...
    publishedDate: "March 1, 2027",
    updatedDate: "March 1, 2027",
    category: "Guides",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "December 16, 2026",
    updatedDate: "December 16, 2026",
    category: "Playbooks",
    readTime: "10 min read",
  ...
  },
  {
    ...
    publishedDate: "October 26, 2026",
    updatedDate: "October 26, 2026",
    category: "Comparisons",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "October 28, 2026",
    updatedDate: "October 28, 2026",
    category: "Copywriting",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "December 18, 2026",
    updatedDate: "December 18, 2026",
    category: "Automation",
    readTime: "10 min read",
  ...
  },
  {
    ...
    publishedDate: "January 1, 2027",
    updatedDate: "January 1, 2027",
    category: "Automation",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "January 4, 2027",
    updatedDate: "January 4, 2027",
    category: "Comparisons",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "November 30, 2026",
    updatedDate: "November 30, 2026",
    category: "Outreach",
    readTime: "8 min read",
  ...
  },
  {
    ...
    publishedDate: "January 27, 2027",
    updatedDate: "January 27, 2027",
    category: "Automation",
    readTime: "9 min read",
  ...
  },
  {
    ...
    publishedDate: "January 22, 2027",
    updatedDate: "January 22, 2027",
    category: "Outreach",
    readTime: "7 min read",
  ...
  },
  {
    ...
    publishedDate: "March 31, 2027",
    updatedDate: "March 31, 2027",
    category: "Guides",
    readTime: "5 min read",
  ...
  },
  {
    ...
    publishedDate: "January 11, 2027",
    updatedDate: "January 11, 2027",
    category: "Outreach",
    readTime: "6 min read",
  ...
  },
  {
    ...
    publishedDate: "February 3, 2027",
    updatedDate: "February 3, 2027",
    category: "Copywriting",
    readTime: "5 min read",
  ...
  },
  {
    ...
    publishedDate: "January 13, 2027",
    updatedDate: "January 13, 2027",
    category: "Playbooks",
    readTime: "6 min read",
  ...
  },
  {
    ...
    publishedDate: "March 24, 2027",
    updatedDate: "March 24, 2027",
    category: "Guides",
    readTime: "7 min read",
  ...
  },
  {
    ...
    publishedDate: "February 8, 2027",
    updatedDate: "February 8, 2027",
    category: "Copywriting",
    readTime: "6 min read",
  ...
  },
  {
    ...
    publishedDate: "March 29, 2027",
    updatedDate: "March 29, 2027",
    category: "Guides",
    readTime: "5 min read",
  ...
  },
  {
    ...
    publishedDate: "December 28, 2026",
    updatedDate: "December 28, 2026",
    category: "Outreach",
    readTime: "5 min read",
  ...
  },
  {
    ...
    publishedDate: "February 17, 2027",
    updatedDate: "February 17, 2027",
    category: "Copywriting",
    readTime: "7 min read",
  ...
  },
  {
    ...
    publishedDate: "April 2, 2027",
    updatedDate: "April 2, 2027",
    category: "Guides",
    readTime: "6 min read",
  ...
  },
  {
    ...
    publishedDate: "November 16, 2026",
    updatedDate: "November 16, 2026",
    category: "Outreach",
    readTime: "6 min read",
  ...
  },
  {
    ...
    publishedDate: "March 26, 2027",
    updatedDate: "March 26, 2027",
    category: "Guides",
    readTime: "8 min read",
