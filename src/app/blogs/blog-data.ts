 ...
 * kept out of the sitemap, llms.txt, the /blogs index, the CollectionPage
 * JSON-LD and related-post links, and it is served `noindex`.
 *
...
export const ALL_BLOGS: BlogItem[] = [
  ...
  },
  {
    ...
    title: "LinkedIn Spam Filters: What They Catch, and What They Do Not",
    description: "LinkedIn's own rules ban using invitations as ads. Here is what the company publishes about spam, what its transparency report shows, and how to stay out of the filter.",
    publishedDate: "February 2, 2026",
    updatedDate: "August 14, 2026",
    category: "Guides",
    readTime: "12 min read",
    bannerSrc: "/blogs/linkedin-spam-filters-how-they-work/cover.avif",
  ...
  },
  {
    ...
    title: "How to Warm Up a LinkedIn Account Without Getting Restricted",
    description: "LinkedIn can lock invitations for a week if a quiet account suddenly sends too many. Here is a conservative four-week warmup, plus what to do if you already hit the limit.",
    publishedDate: "February 9, 2026",
    updatedDate: "August 14, 2026",
    category: "Automation",
    readTime: "12 min read",
    bannerSrc: "/blogs/how-to-warm-up-linkedin-account/cover.avif",
  ...
  },
  {
    ...
    title: "LinkedIn Weekly Connection Limits: What Happens When You Hit Them",
    description: "LinkedIn does not publish a fixed weekly invite number. Here is what it does publish, why the popular 100-a-week figure is only a rumor, and how to work under the real limit.",
    publishedDate: "February 11, 2026",
    updatedDate: "August 14, 2026",
    category: "Automation",
    readTime: "11 min read",
    bannerSrc: "/blogs/linkedin-weekly-connection-limits/cover.avif",
  ...
  },
  {
    ...
    description: "LinkedIn lets free accounts add a 200-character note to only three invitations a month. Here is how to use that space, and when a blank request is better.",
    publishedDate: "June 13, 2026",
    updatedDate: "August 14, 2026",
    category: "Outreach",
    readTime: "14 min read",
    bannerSrc: "/blogs/how-to-write-a-linkedin-connection-request-that-gets-accepted/cover.avif",
