...
const faqItems = [
  ...
  },
  {
    ...
    answer: "Reference the ROI of your solution: compare the monthly platform cost (like Omentir's $49/month Pro plan) to the cost of manual lead sourcing, showing how much time is saved."
  },
  {
