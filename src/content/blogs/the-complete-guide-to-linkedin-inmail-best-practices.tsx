...
const tocItems = [
  ...
  { id: "deliverability-safety", label: "Deliverability safeguards and spam avoidance", level: 1 },
  { id: "pitfalls", label: "InMail mistakes to avoid", level: 1 },
  ...
  return (
    ...
    >
      <div id="introduction" className="scroll-mt-28">
        <p>
          LinkedIn InMail is one of the strongest enterprise sales channels in B2B. Because InMails skip standard connection request requirements, messages land directly in the primary inbox of high-value prospects, enterprise decision-makers, and executives who keep their network settings locked down.
        </p>
        <p>
          InMails come with a catch: they carry an explicit "InMail" or "Premium" label in the recipient's inbox. That label triggers skepticism. It announces that the message is a cold marketing reach-out. If your copy is generic, long, or overly sales-heavy, it will be archived or deleted. To raise InMail open and response rates, write with precision: tight structure and careful subject lines.
        </p>
        ...
        <p>
          Many B2B founders and outbound reps struggle to decide between sending a standard connection request or spending a premium InMail credit.
        </p>
        <p>
        ...
        <ul style={{ listStyleType: "disc" }} className="list-disc pl-6 space-y-2 text-zinc-850 my-4">
          ...
          <li><strong>The Frictionless proof:</strong> Reference a single metric or case study showing how you solved this exact problem for a similar company, without using corporate jargon.</li>
        ...
        <div className="my-6 rounded-xl border border-zinc-200 bg-[#ba38710d] p-6 relative overflow-hidden shadow-[0_4px_20px_rgba(15,23,42,0.02)]">
          ...
          <div className="pl-4">
            ...
            <div className="mt-4 pt-4 border-t border-zinc-300 text-xs text-zinc-600">
              <strong>Why it works:</strong> It targets a technology they are actively using, shows that you understand its common flaws, and presents a non-disruptive, lightweight alternative without aggressive sales pitches.
            </div>
          </div>
        </div>
        ...
        <div className="my-6 rounded-xl border border-zinc-200 bg-[#ba38710d] p-6 relative overflow-hidden shadow-[0_4px_20px_rgba(15,23,42,0.02)]">
          ...
          <div className="pl-4">
            ...
            <p className="mt-3 text-sm text-zinc-800 font-mono italic leading-relaxed">
              ...
              We mapped out a clean operational blueprint showing how growth teams can use automated buyer intent crawlers to hit those metrics without hiring more SDRs. Would you be open to checking out a brief PDF?"
            </p>
            <div className="mt-4 pt-4 border-t border-zinc-300 text-xs text-zinc-600">
              <strong>Why it works:</strong> It matches the public business goals their executive team has announced. That makes the outreach look timed and specific, not generic.
            </div>
          </div>
        </div>
        ...
        <div className="my-6 rounded-xl border border-zinc-200 bg-[#ba38710d] p-6 relative overflow-hidden shadow-[0_4px_20px_rgba(15,23,42,0.02)]">
          ...
          <div className="pl-4">
            ...
            <p className="mt-3 text-sm text-zinc-800 font-mono italic leading-relaxed">
              ...
              We put together a brief checklist showing how we moved 70% of our pipeline onto warm LinkedIn social selling. Can I drop the link over?"
            </p>
            <div className="mt-4 pt-4 border-t border-zinc-300 text-xs text-zinc-600">
              <strong>Why it works:</strong> It uses a trusted community association, focuses on a shared industry headache (email deliverability), and asks for permission before sharing a helpful resource.
            </div>
          </div>
        </div>
        ...
        <h2
          ...
          className="text-2xl font-semibold tracking-tight text-black mt-10 pt-2 border-b border-zinc-200 pb-2 scroll-mt-28"
        >
          Deliverability safeguards and spam avoidance
        </h2>
        <p>
