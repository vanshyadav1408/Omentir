...
const tocItems = [
  ...
  { id: "operational-math", label: "The math of outreach volume vs personalization", level: 1 },
] as const;
  ...
  return (
    ...
    >
      <div id="introduction" className="scroll-mt-28">
        ...
        <p>
          Many outbound teams try high-volume tools built for mass markets, hoping scale will make up for low relevance. That backfires. Modern executives have sharp filters, both technological and cognitive. They spot automated templates instantly. To get executive buyers, enterprise teams need a human-in-the-loop (HITL) outreach method: an AI salesman for research and drafts, plus a sales professional for judgment.
        </p>
        <p>
        ...
        <p>
          Under this framework, the salesperson's efficiency jumps. Instead of spending six hours a day researching contacts, scraping databases, and drafting emails, the salesperson spends thirty minutes reviewing, refining, and approving high-quality drafts. The rest of the day goes to conversations with people who replied. The job shifts from data entry to advisor work.
        </p>
        ...
        <h2
          ...
          className="text-2xl font-semibold tracking-tight text-black mt-10 pt-2 border-b border-zinc-200 pb-2 scroll-mt-28"
        >
          The math of outreach: high-volume spam vs personalization
        </h2>
        <p>
